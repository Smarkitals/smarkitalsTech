    ...
    return(
        ...
        <div className={styles.main}>
            ...
            <div className={styles.headingMain} >
                <h3>
                    Smarter Solutions That Take Your Business to the Next Level
                </h3>
                <p className={styles.subHeading}>We design, develop, and implement automation tools that help you work smarter, not harder</p>
            </div>
